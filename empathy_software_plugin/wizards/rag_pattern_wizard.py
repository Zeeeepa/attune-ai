        ...
        for file_path in rag_impl:
            try:
                with open(file_path, 'r') as f:
                    content = f.read()
                    if any(kw in content.lower() for kw in ['rerank', 'cross-encoder', 'cohere.rerank']):
                        return True
            except:
                pass
        return False
            ...
            try:
                with open(file_path, 'r') as f:
                    ...
                    if any(kw in content.lower() for kw in [
                        'query_rewrite', 'query_expansion', 'decompose', 'intent'
                    ]):
                        return True
            except:
                pass
        ...
        for file_path in rag_impl:
            try:
                with open(file_path, 'r') as f:
                    content = f.read()
                    if any(kw in content.lower() for kw in [
                        'evaluate', 'metrics', 'ground_truth', 'precision', 'recall'
                    ]):
                        return True
            except:
                pass
        ...
        for file_path in rag_impl:
            try:
                with open(file_path, 'r') as f:
                    content = f.read()
                    if any(kw in content.lower() for kw in [
                        'prune', 'summarize', 'deduplicate', 'context_budget'
                    ]):
                        return True
            except:
                pass
