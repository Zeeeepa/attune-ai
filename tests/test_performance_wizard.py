...
class TestPerformanceProfilingWizard:
    ...
    async def test_n_plus_one_detection(self):
        ...
        assert 'eager loading' in n_plus_one[0]['fix_suggestion'].lower() or 'batch' in n_plus_one[0]['fix_suggestion'].lower()
    ...
    async def test_trajectory_analysis(self):
        ...
        assert trajectory['state'] in ['degrading', 'critical']
    ...
    async def test_predictions_generated(self):
        ...
        perf_preds = [p for p in predictions if 'performance' in p['type'].lower() or 'bottleneck' in p['type'].lower()]
    ...
    async def test_recommendations_generated(self):
        ...
        assert any('optimize' in r.lower() or 'cache' in r.lower() or 'batch' in r.lower() for r in recommendations)
    ...
    async def test_insights_generation(self):
        ...
        assert insights['optimization_potential'] in ['HIGH', 'MEDIUM']
...
class TestProfilerParsers:
    ...
    async def test_simple_json_parser(self):
        ...
        from empathy_software_plugin.wizards.performance.profiler_parsers import SimpleJSONProfilerParser
...
class TestBottleneckDetector:
    ...
    async def test_hot_path_threshold(self):
        ...
        from empathy_software_plugin.wizards.performance.bottleneck_detector import BottleneckDetector
...
class TestTrajectoryAnalyzer:
    ...
    async def test_degrading_trajectory_detection(self):
        ...
        from empathy_software_plugin.wizards.performance.trajectory_analyzer import TrajectoryAnalyzer
    ...
    async def test_optimal_trajectory(self):
        ...
        assert trajectory['state'] == 'optimal'
