...
''')
            ...
            endpoint_config = {
                payment_file: {'endpoint_public': True}
            }
...
''')
            ...
            assert any(word in recommendation_text for word in ['sql', 'injection', 'parameterized', 'security'])

            # Should mention performance
            assert any(word in recommendation_text for word in ['performance', 'optimize', 'batch', 'cache', 'query'])
