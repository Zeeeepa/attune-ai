...
def show_configuration():
    ...
    agents = [
        ...
        ("integration_test_creator", "Create integration tests for module interactions", "progressive"),
...
def main():
    ...
    # Confirm execution
    console.print("[bold yellow]⚠️  This will execute 11 AI agents to generate tests across your project.[/bold yellow]")
