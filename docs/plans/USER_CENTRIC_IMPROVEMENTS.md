...
- Python CLI: `python -m attune.models.cli provider`
...
**File:** `src/attune/workflows/progress.py`
...
**File:** `src/attune/workflows/base.py` (modifications)
...
class WorkflowService {
  async estimateCost(workflow: string, input: string): Promise<CostEstimate> {
    // Call Python: python -m attune.models.token_estimator ...
  }
...
| File | Action |
|------|--------|
| `src/attune/models/token_estimator.py` | Create |
| `src/attune/workflows/progress.py` | Create |
| `src/attune/workflows/base.py` | Add progress hooks |
...
**File:** `src/attune/orchestration/protocol.py`
...
**File:** `src/attune/orchestration/default.py`
...
**File:** `src/attune/enterprise/orchestration/langgraph_orchestrator.py`
...
**File:** `src/attune/enterprise/orchestration/crewai_orchestrator.py`
...
**File:** `src/attune/enterprise/orchestration/hybrid_orchestrator.py`
...
| File | Action |
| ---- | ------ |
| `src/attune/orchestration/__init__.py` | Create package |
| `src/attune/orchestration/protocol.py` | Create Orchestrator protocol |
| `src/attune/orchestration/default.py` | Create DefaultOrchestrator |
| `src/attune/enterprise/__init__.py` | Create enterprise package |
| `src/attune/enterprise/orchestration/langgraph_orchestrator.py` | Create |
| `src/attune/enterprise/orchestration/crewai_orchestrator.py` | Create |
| `src/attune/enterprise/orchestration/hybrid_orchestrator.py` | Create |
| `src/attune/enterprise/agents/prebuilt.py` | Pre-built agent definitions |
