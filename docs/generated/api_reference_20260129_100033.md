---
description: Empathy Framework - Cross-Platform Utilities API Reference API reference: **Version:** 1.0.0 **Module:** `attune.platform_utils` **License:** Fair Source Li
---
...
The `attune.platform_utils` module provides a comprehensive suite of cross-platform utilities for the Empathy Framework. This module abstracts away platform-specific differences, enabling developers to write code that works seamlessly across Windows, macOS, and Linux.
