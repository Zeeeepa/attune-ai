---
description: Attune AI - Cross-Platform Utilities API Reference API reference: **Version:** 1.0.0 **Module:** `attune.platform_utils` **License:** Apache 2.0 Li
---
...
The `attune.platform_utils` module provides a comprehensive suite of cross-platform utilities for the Attune AI. This module abstracts away platform-specific differences, enabling developers to write code that works seamlessly across Windows, macOS, and Linux.
...
- `attune.config._validate_file_path` (for file path validation)
...
import attune.platform_utils as platform_utils
