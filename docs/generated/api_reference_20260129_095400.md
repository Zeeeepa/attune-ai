---
description: Empathy Framework - Cross-Platform Utilities API Reference API reference: **Version:** 1.0 **Module:** `attune.platform_utils` **License:** Fair Source Lice
---
...
The `attune.platform_utils` module provides cross-platform utilities for the Empathy Framework, abstracting platform-specific differences to ensure consistent behavior across Windows, macOS, and Linux systems.
