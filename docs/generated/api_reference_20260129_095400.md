---
description: Attune AI - Cross-Platform Utilities API Reference API reference: **Version:** 1.0 **Module:** `attune.platform_utils` **License:** Apache 2.0 Lice
---

# Attune AI - Cross-Platform Utilities API Reference

**Version:** 1.0
**Module:** `attune.platform_utils`
...
The `attune.platform_utils` module provides cross-platform utilities for the Attune AI, abstracting platform-specific differences to ensure consistent behavior across Windows, macOS, and Linux systems.
...
```python
#!/usr/bin/env python3
"""Quick start example for attune.platform_utils."""
...
import attune.platform_utils as pu
...
The module imports `_validate_file_path` from `attune.config` for path validation in file operations.

### 1.4 Module Structure

```
attune.platform_utils
│
├── Platform Detection
│   ├── is_windows()      → bool
│   ├── is_macos()        → bool
