---
description: Cache Statistics and Performance Reporting - API Reference API reference: **Version:** 1.0 **Copyright:** 2025 Smart AI Memory, LLC **License:** Apache License 2.0
---
...
```python
# Required dependencies (installed with attune)
