---
description: Cache Statistics and Performance Reporting - API Reference API reference: **Version:** 1.0 **Module:** `empathy_os.cache_analyzer` **Copyright:** 2025 Smart AI 
---
...
**Dependencies:**
- `empathy_os.cache_monitor` — Provides `CacheMonitor` and `CacheStats` classes
