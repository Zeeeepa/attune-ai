---
description: Cache Statistics and Performance Reporting - API Reference Documentation API reference: > **Module:** `empathy_os.cache_analyzer` > **Version:** 1.0 > **License
---
...
**Dependencies:**
- `empathy_os.cache_monitor` module (provides `CacheMonitor` and `CacheStats`)
