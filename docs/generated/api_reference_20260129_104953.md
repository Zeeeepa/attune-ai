...
**Returns:**
- `CacheHealthScore | None`: CacheHealthScore with assessment and recommendations
...
**Returns:**
- `dict[str, CacheHealthScore]`: Dictionary mapping cache names to CacheHealthScore
