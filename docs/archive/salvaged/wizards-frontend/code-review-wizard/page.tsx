...
export default function CodeReviewWizardPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-400">
            Conduct effective code reviews with security and performance checks.
          </p>
        </div>

        <div className="bg-gradient-to-br from-amber-900/50 to-orange-900/50 border border-amber-500/30 rounded-2xl p-8 mb-8">
          <div className="flex items-start gap-4">
            <div className="text-4xl">🚧</div>
            <div>
              <h2 className="text-2xl font-bold mb-2">Coming Soon</h2>
              <p className="text-gray-300 mb-4">
                This wizard is currently under development. It will help you conduct code reviews with:
              </p>
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
                  <span>Comprehensive review checklists</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1">✓</span>
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
          ...
          <p className="text-gray-400 mb-4">
            You can use our General Wizard to get AI assistance with code reviews right now.
          </p>
          <Link
            href="/wizard"
